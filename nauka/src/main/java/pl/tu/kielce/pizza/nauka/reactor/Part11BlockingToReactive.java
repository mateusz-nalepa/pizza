...
import pl.tu.kielce.pizza.nauka.reactor.repository.BlockingRepository;
...
//========================================================================================
	...
	Flux<ReactiveUser> blockingRepositoryToFlux(BlockingRepository<ReactiveUser> repository) {
		return null;
	}
...
//========================================================================================
	...
	Mono<Void> fluxToBlockingRepository(Flux<ReactiveUser> flux, BlockingRepository<ReactiveUser> repository) {
		return null;
	}
